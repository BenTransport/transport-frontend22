      ...
      <div className="lg:pr-8 lg:pt-4">
        <div className="lg:max-w-lg">
          <div className="flex flex-col w-full font-bold uppercase max-md:max-w-full">
            ...
            <div data-aos="fade-down" className="mt-4 text-3xl sm:text-4xl leading-10 text-gray-900 max-md:max-w-full">
              Förenkla <span className="text-sky-800">din flyttupplevelse</span>
            </div>
          </div>

          <p data-aos="fade-down" className="mt-6 text-lg leading-8 text-gray-600">
            Vårt mål är att göra din upplevelse smidig, effektiv och stressfri, oavsett om du flyttar hem eller behöver hjälp med dagliga uppgifter.
          </p>
          <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
            <div className="relative pl-9" data-aos="fade-right">
              ...
              <dd className="inline ml-3">
                Våra professionella städteam ser till att ditt utrymme är fläckfritt, oavsett om det är efter flytt eller regelbundet underhåll.
              </dd>
            </div>
            <div className="relative pl-9" data-aos="fade-right">
              <dt className="inline font-semibold text-gray-900">
              ...
              <dd className="inline ml-3">
                Behöver du ett extra par händer? Våra utbildade hjälpare hjälper till med packning, lyft och organisering för att göra din flytt problemfri.
              </dd>
            </div>
            <div className="relative pl-9" data-aos="fade-right">
              <dt className="inline font-semibold text-gray-900">
              ...
              <dd className="inline ml-3">
                Från små skåpbilar till stora lastbilar, våra transporttjänster ser till att dina tillhörigheter flyttas säkert och i tid.
              </dd>
            </div>
          </dl>
        </div>
      </div>
      <img src="/test.jpg" alt="Flytt- och transporttjänster" className="w-[48rem] hidden lg:flex max-w-none sm:w-[57rem] rounded-3xl md:-ml-4 lg:-ml-0" width="2432" height="1442" />
    </div>
  </div>
</section>
