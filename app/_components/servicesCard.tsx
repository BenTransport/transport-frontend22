...
export function ServicesCard({ service, handleOpenForm, pricing }: any) {
    ...
    return (
        <div className="w-full sm:w-[300px] group/card overflow-hidden rounded-xl group">
            <div
                style={
                    {
                        ...
                        service.name.toLowerCase() == "helper" ?
                            <>
                                <p className="font-normal text-sm text-gray-50 relative z-10">
                                    Kostnad per hjälpare :  {pricing.helper.ratePerHelperPerHour} SEK
                                </p>
                            </>
                            :
                            service.name.toLowerCase() == "transport" ?
                                <>
                                    <p className="font-normal text-sm text-gray-50 relative z-10">
                                    Kostnad per km :  {pricing.transport.ratePerKm} SEK
                                    </p>
                                </>
                                :
                                ...
                                <>
                                    <p className="font-normal text-sm text-gray-50 relative z-10">
                                        Kostnad per flyttstädare :  {pricing.cleaning.ratePerCleaner} SEK
                                    </p>
                                </>
                    }
